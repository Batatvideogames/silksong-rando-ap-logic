...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| L | left | left | [Bilewater Upper East Column (Shadow_26)](bilewater-upper-east-column.md) | UR | none |  |  |  |
| R | right | right | [Bilewater East Bench (Shadow_08)](bilewater-east-bench.md) | L | none |  |  | Only opens when breaking the left wall in shadow_08 |
