...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| LR | lower right | low right | [Bilewater Lower East Hall (Shadow_03)](bilewater-lower-east-hall.md) | L | none |  |  |  |
| UR | upper right | halfway up | [Bilewater Upper East Column (Shadow_26)](bilewater-upper-east-column.md) | LL | (clawline OR crest pogo) AND (faydown cloak OR drifter's cloak) |  |  |  |
| LL | lower left | low left | [Bilewater West Hall (Shadow_04b)](bilewater-west-hall.md) | R | none |  |  |  |
| MR | middle right | mid right | [Bilewater Shakra Room (Shadow_23)](bilewater-shakra-room.md) | L | none |  |  |  |
| UL | upper left | up left | [Bilewater Upper West Column (Shadow_14)](bilewater-upper-west-column.md) | LR | none |  |  |  |
