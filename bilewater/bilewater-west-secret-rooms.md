...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| L | lower | lower area | [Bilewater Organ Entrance (Shadow_04)](bilewater-organ-entrance.md) | C | none |  |  |  |
| C | ceiling | top area | [Bilewater Citadel Exit (Shadow_22)](bilewater-citadel-exit.md) | B | cling grip AND crest pogo AND faydown cloak |  |  | Requires an annoying enemy lure. Medium_skips. Should be one-way normally. |
