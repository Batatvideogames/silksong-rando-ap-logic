...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| LR | lower right | bottom right | [Bilewater East Bench (Shadow_08)](bilewater-east-bench.md) | C | right attack |  |  | breakable wall |
| L | left | left door plat | [Bilewater Hanging Corpse Room (Shadow_16)](bilewater-hanging-corpse-room.md) | R | none |  |  |  |
| R | right | right door plat | [Bilewater Vertical Sac Pogo Room (Shadow_19)](bilewater-vertical-sac-pogo-room.md) | LL | none |  |  |  |
