...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| UR | right1 | Upper Level | [Shellwood Top Room (Shellwood_26)](shellwood-top-room.md) | L | Cling Grip OR Silk Soar OR ( Dash AND Scuttlebrace ) |  | Verified |  |
| LR | right2 | Ground Level | [Shellwood Flower Pogo Upper Hall (Shellwood_20)](shellwood-flower-pogo-upper-hall.md) | L | ( Dash AND Scuttlebrace ) OR Cling Grip OR Clawline OR Faydown Cloak OR Ledge Grab |  | Verified |  |
| ML | left2 | Central Level | [Cling Grip Side Room (Shellwood_11)](cling-grip-side-room.md) | LR | Dash OR Sprint OR Clawline OR SharpDart OR easy Beast Crest pogo OR Faydown Cloak OR Drifters Cloak |  | Verified |  |
| UL | left1 | Upper Level | [Cling Grip Side Room (Shellwood_11)](cling-grip-side-room.md) | UR | None |  | Verified |  |
| MR | right3 | Central Level | [Sister Splinter (Shellwood_18)](sister-splinter.md) | L | ( Dash AND Scuttlebrace ) OR Cling Grip OR Clawline OR Faydown Cloak OR Ledge Grab |  | Verified |  |
